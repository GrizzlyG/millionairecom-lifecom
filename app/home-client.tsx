...
export default function HomeClient({ products, currentUser, userOrders, settings }: any) {
  ...
  return (
    <div className="p-2 sm:p-8">
      <Container>
        ...
        <div ref={productGridRef} className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 2xl:grid-cols-6 gap-4 sm:gap-8">
